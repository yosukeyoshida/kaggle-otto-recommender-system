...
--       FROM `kaggle-352109.otto.aid`
  ...
  SELECT
    ...
    MAX(CASE WHEN day_num = 9 THEN clicks_rank ELSE NULL END) AS clicks_rank_day9,
    MAX(CASE WHEN day_num = 10 THEN clicks_rank ELSE NULL END) AS clicks_rank_day10,
    MAX(CASE WHEN day_num = 11 THEN clicks_rank ELSE NULL END) AS clicks_rank_day11,
    ...
    MAX(CASE WHEN day_num = 9 THEN carts_rank ELSE NULL END) AS carts_rank_day9,
    MAX(CASE WHEN day_num = 10 THEN carts_rank ELSE NULL END) AS carts_rank_day10,
    MAX(CASE WHEN day_num = 11 THEN carts_rank ELSE NULL END) AS carts_rank_day11,
    ...
    MAX(CASE WHEN day_num = 9 THEN orders_rank ELSE NULL END) AS orders_rank_day9,
    MAX(CASE WHEN day_num = 10 THEN orders_rank ELSE NULL END) AS orders_rank_day10,
    MAX(CASE WHEN day_num = 11 THEN orders_rank ELSE NULL END) AS orders_rank_day11,
  ...
  GROUP BY aid
    ...
    SELECT
        ...
        a3.clicks_rank_day8,
        a3.clicks_rank_day9,
        a3.clicks_rank_day10,
        a3.clicks_rank_day11,
        ...
        a3.orders_rank_day8,
        a3.orders_rank_day9,
        a3.orders_rank_day10,
        a3.orders_rank_day11,
...
SELECT
    ...
    COALESCE(ais.clicks_rank_day9, 1000000) AS clicks_rank_day9,
    COALESCE(ais.clicks_rank_day10, 1000000) AS clicks_rank_day10,
    COALESCE(ais.clicks_rank_day11, 1000000) AS clicks_rank_day11,
    ...
    COALESCE(ais.carts_rank_day9, 1000000) AS carts_rank_day9,
    COALESCE(ais.carts_rank_day10, 1000000) AS carts_rank_day10,
    COALESCE(ais.carts_rank_day11, 1000000) AS carts_rank_day11,
    ...
    COALESCE(ais.orders_rank_day9, 1000000) AS orders_rank_day9,
    COALESCE(ais.orders_rank_day10, 1000000) AS orders_rank_day10,
    COALESCE(ais.orders_rank_day11, 1000000) AS orders_rank_day11,
