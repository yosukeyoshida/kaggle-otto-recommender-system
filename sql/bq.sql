EXPORT DATA
  OPTIONS(
    uri='gs://kaggle-yosuke/lgbm_dataset/20230120/train_*.parquet', -- FIXME
--     uri='gs://kaggle-yosuke/lgbm_dataset_test/20230120/test_*.parquet',
    format='PARQUET',
    overwrite=true
  )
AS
...
SELECT
    ...
    COALESCE(ais.clicks_rank, 0) AS clicks_cnt,
    COALESCE(ais.carts_rank, 0) AS carts_cnt,
    COALESCE(ais.orders_rank, 0) AS orders_cnt,
